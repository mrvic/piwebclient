...
class ApiClient
{
	...
	public static $KERBEROS_AUTH = "KERBEROS";
     ...
     */
    public function __construct(\PIWebAPI\Client\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \PIWebAPI\Client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\PIWebAPI\Client\ObjectSerializer::sanitizeForSerialization($postData));
        }
		...
		if ($this->config->getAuthMethod() === self::$BASIC_AUTH) {
			curl_setopt($curl, CURLOPT_HTTPAUTH, CURLAUTH_BASIC);
			curl_setopt($curl, CURLOPT_USERPWD, $username.":".$password);  
		} elseif ($this->config->getAuthMethod() === self::$KERBEROS_AUTH) {
