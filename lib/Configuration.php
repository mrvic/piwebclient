...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://proghackuc2017.osisoft.com/piwebapi';
    ...
    public function getUsername()
    {
	   ...
	   /**
     * Sets the PI Web API authentication method
     *
     * @param string $authMethod One of the PI Web API Authentication methods: "KERBEROS", "BASIC" or "ANONYMOUS"
	 *
     * @return Configuration
     */
    ...
    {
        $report  = 'PHP SDK (PIWebAPI\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.9.0.235' . PHP_EOL;
