...
class ChannelApi
{
     ...
     * @return void
     */
    public function channelInstances()
    {
        list($response) = $this->channelInstancesWithHttpInfo();
        return $response;
    }

    /**
     * Operation channelInstancesWithHttpInfo
     *
     * Retrieves a list of currently running channel instances.
     *
     * @throws \PIWebAPI\Client\ApiException on non-2xx response
     ...
     */
    public function channelInstancesWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/channels/instances";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
